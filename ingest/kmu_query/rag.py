...
PROVIDER_TIMEOUT_SECONDS = float(os.environ.get("KMU_PROVIDER_TIMEOUT_SECONDS", "120"))
...
def _default_client():
    ...
    return anthropic.Anthropic(timeout=PROVIDER_TIMEOUT_SECONDS)
...
def _stream_provider(*, provider: str, model: str, system: str, prompt: str, max_tokens: int,
    ...
    if provider == "anthropic":
        ...
        import cohere
        client = cohere.ClientV2(cohere_key, timeout=PROVIDER_TIMEOUT_SECONDS)
